...
<cffunction name="testSimpleXMLModule" returntype="void" access="public">
	...
	<cfset obj = obj[1] />
	<cfset assertEquals("ModelGlue.tests.unittests.gesture.module.Controller", GetMetadata(mg.getController(obj.target)).name, "Controller not of right type") />
...
<cffunction name="testRecursiveResultLoading" returntype="void" access="public">
	...
	<cfset mg.setConfigSetting("primaryModule", "/ModelGlue/tests/unittests/gesture/module/recursiveResultModule.xml")>
...
<cffunction name="testViewHelperSetting" returntype="void" access="public">
	<cfset var mg = createModelGlue("/ModelGlue/tests/unittests/gesture/eventrequest/ColdSpring.xml") />
	<cfset var loader = "" />
	<cfset var obj = "" />
	<cfset var beanFactory = "" />
